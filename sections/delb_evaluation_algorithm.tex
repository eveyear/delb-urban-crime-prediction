...
The multiscale implementation parallelizes independent city--spatial-scale--
temporal-scale cells with six thread workers and writes a checkpoint after
each completed cell; replicate-level outputs and seeds are retained for
reconciliation.
