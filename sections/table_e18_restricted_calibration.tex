...
\toprule
\textbf{City} & \textbf{Observed CMI} & \textbf{Null mean} &
\textbf{\(p\)} & \textbf{Type I error} &
\textbf{Power at 0.02 bit} & \textbf{Power at 0.05 bit} &
\textbf{Power at highest evaluated CMI}\\
\midrule
