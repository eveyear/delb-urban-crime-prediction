...
\centering
\footnotesize
\begin{tabularx}{\textwidth}{p{2.5cm}Xp{2.0cm}p{2.0cm}p{2.2cm}}
\toprule
...
Lagged crime & Previous-period crime count, discretized as
\(\{0,1,2,\geq3\}\); baseline state & 1 km grid & Previous day & Yes, lagged\\
